            ...
            <div v-for="(items,indexs) in calc_data" :key="indexs">
                <div class="calc-items flex align-center" @click="calc_data[indexs].showPicker = true">
                    ...
                    <div class="center flex-auto">
                        <div><input type="text" name="age" placeholder="请选择" :value="calc_data[indexs].value"></div>
                        <p>{{items.title}}</p>
                    </div>
...
.van-nav-bar {
    ...
    .calc-list .calc-items{
        width: 100%;
        padding:.16rem .4rem .16rem;
        background-color: #fff;
    }
    .calc-list .calc-items:active{
        background-color: rgba(0, 0, 0, 0.05)
    }
    .calc-list .calc-items .right{
        width: .213333rem;
        height: .346667rem;
        margin: 0 .106667rem;
    }
    .calc-list .calc-items .left{
        width: 2.133333rem;
        height: 1.173333rem;
        overflow: hidden;
    }
    .calc-list .calc-items .left>.tag-left{
        width:2.4rem;
        height:1.2rem;
    ...
    .calc-list .calc-items .center>div{
        height: .72rem;
        width: 100%;
        display: flex;
    ...
    .calc-list .calc-items .center>div>.inputMask{
        width: 100%;
        height: 100%;
        position: absolute;
        left: 0;
    ...
    .calc-list .calc-items .center>div>input{
        width: 100%;
        height: .533333rem;
    ...
    .calc-list .calc-items .center>div>input::-webkit-input-placeholder{ /*WebKit browsers*/
        font-size:.426667rem;
    ...
    .calc-list .calc-items .center>div>input::-moz-input-placeholder{ /*Mozilla Firefox*/
        font-size:.426667rem;
        color:rgba(197,197,201,1);
        font-weight: 400;
        font-family:"PingFang SC";
    ...
    .calc-list .calc-items .center>div>input::-ms-input-placeholder{ /*Internet Explorer*/ 
        font-size:.426667rem;
        color:rgba(197,197,201,1);
        font-weight: 400;
        font-family:"PingFang SC";
    }
    .calc-list .calc-items .center p{
        font-size:.32rem;
        color:rgba(197,197,201,1);
    }
    .calc-list .calc-btn{
